...
// Disable enum constexpr conversion warnings for this file - the template
// code intentionally casts integers to enum types, with runtime bounds checks
// ensuring only valid values are actually used
